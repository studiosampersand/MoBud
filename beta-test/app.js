const VERSION='0.000.008-hotfix7';
...
let state=migrate(),viewDate=new Date(),calendarDate=new Date(),selectedDay=todayISO(),pendingAttachment={trip:null,expense:null},deferredPrompt=null,newWorker=null,tutorialIndex=0,tripOtherCoords={from:null,to:null};
...
function resetTrip(){tripForm.reset();tripEditId.value='';tripFormTitle.textContent='Log trip';tripDate.value=todayISO();pendingAttachment.trip=null;tripOtherCoords={from:null,to:null};tripFromOtherWrap.classList.add('hidden');tripToOtherWrap.classList.add('hidden');tripFromOtherSuggestions.innerHTML='';tripToOtherSuggestions.innerHTML='';showAttachment('trip');cancelTripEdit.classList.add('hidden');fillLocations()}
