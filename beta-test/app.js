...
function showVersionSafetyGate(){
  ...
  modal.querySelector('[data-version-backup]').onclick=()=>{downloadBackup('before-v0.000.016');versionGateBackupTaken=true;confirmBtn.disabled=false;toast(t('Safety backup downloaded.'))};
