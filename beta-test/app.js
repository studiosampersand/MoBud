...
function mergeLocalBackup(localData,backupData){const local=normalized(localData),merged=mergeState(local,backupData);merged.settings.driveConnected=!!local.settings.driveConnected;merged.settings.storageMode=local.settings.storageMode||'local';merged.settings.lastDriveSync=local.settings.lastDriveSync||'';return merged}
